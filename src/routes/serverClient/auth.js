...
//route list
auth.post('/register', validationRule.createNewSellerValidator, validation, userController.registerUser);
...
auth.post('/login', validationRule.validatorLogin, validation, userController.loginUser);
